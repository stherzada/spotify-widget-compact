...
export default function ConfigForm() {
  ...
  useEffect(() => {
    ...
    if (storedPrefs) {
      try {
        ...
        console.warn("Failed to parse preferences from local storage");
      }
    }
  ...
  return (
    <div className={`${styles.card} ${sid ? styles.connected : ""}`}>
          ...
          <div className={styles.layout}>
            <div className={styles.formColumn}>
              <div className={styles.section}>
                <p className={styles.sectionLabel}>Behavior</p>
                ...
                <label className={styles.field}>
                  ...
                  <span className={styles.hint}>
                    Lets viewers reveal the widget with a `!music` chat command.
                  </span>
                </label>
                ...
                <label className={styles.field}>
                  ...
                  />
                  <span className={styles.hint}>0 = always visible</span>
                </label>
              </div>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.appearanceGrid}>
                  <label className={`${styles.settingCard} ${styles.toggleCard}`}>
                    ...
                    <span className={styles.toggle}>
                      <input
                        ...
                        onChange={(e) =>
                          setPrefs((p) => ({ ...p, hideAlbumArt: e.target.checked }))
                        }
                      />
                  ...
                  <label className={`${styles.settingCard} ${styles.toggleCard}`}>
                    ...
                    <span className={styles.toggle}>
                      <input
                        ...
                        onChange={(e) =>
                          setPrefs((p) => ({ ...p, glassEffect: e.target.checked }))
                        }
                      />
                      <span className={styles.toggleTrack}>
                        <span className={styles.toggleThumb} />
                  ...
                  <label className={styles.settingCard}>
                    ...
                    />
                    <span className={styles.hint}>Progress bar</span>
                  </label>
                  ...
                  <label className={styles.settingCard}>
                    ...
                    />
                    <span className={styles.hint}>Song title &amp; artist</span>
                  </label>
                </div>
              </div>
            </div>
